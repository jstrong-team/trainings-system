angular.module('approvePageModule').controller('editApproveController', ['$scope', '$routeParams', 'getApproveData', 'parseService', 'approveService', '$location',
    function ($scope, $routeParams, getApproveData, parseService, approveService, $location) {
        ...
        getApproveData().then(function (data, status, headers, config) {
            ...
            for (j = 0; j < $scope.editInfo.newDates.length; j++) {
