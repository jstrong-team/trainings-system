...
INSERT INTO `meet` VALUES (1,1,'2015-07-02 12:00:00'),(2,1,'2015-07-07 13:00:00'),(3,1,'2015-07-09 12:00:00'),(4,1,'2015-07-14 12:00:00'),(5,1,'2015-07-15 12:00:00'),(6,1,'2015-07-21 12:00:00'),(7,1,'2015-07-23 12:00:00'),(8,1,'2015-07-28 15:00:00'),(9,1,'2015-07-30 12:00:00'),(10,1,'2015-08-04 12:00:00'),(11,1,'2015-08-06 12:00:00'),(12,1,'2015-08-11 12:00:00'),(13,1,'2015-08-13 14:00:00'),(14,1,'2015-08-18 12:00:00'),(15,1,'2015-08-20 12:00:00'),(16,1,'2015-08-25 12:00:00'),(17,1,'2015-08-27 12:00:00'),(18,2,'2015-07-08 15:00:00'),(19,3,'2015-09-01 06:00:00'),(20,4,'2015-06-04 12:00:00'),(21,5,'2015-09-07 12:00:00'),(23,1,'2015-09-12 14:45:56'),(24,1,'2015-09-12 14:45:56');
...
/*!50001 VIEW `new_view` AS select `t`.`id` AS `id`,`t`.`name` AS `name`,`t`.`annotation` AS `annotation`,`m`.`date` AS `date` from (`training` `t` join `meet` `m` on((`t`.`id` = `m`.`training_id`))) where (`t`.`approve` = 1) order by `m`.`date` */;
...
-- Dump completed on 2015-07-22 17:26:01
